...
if (process.env.DEEPSPEECH_MODEL) {
  ...
  DEEPSPEECH_MODEL = __dirname + "./models/deepspeech-0.9.3-models";
}
...
const VAD_MODE = Mode.VERY_AGGRESSIVE;
...
if (process.argv[2]) {
  ...
  var file = createReadStream(process.argv[2]);
  console.log("File: ", file);
  console.log("Reader: ", new Reader());
